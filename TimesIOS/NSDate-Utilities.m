...
-(NSString *)toStringWithFormat:(NSString *)_dateFormat
{
...
-(NSString *)GetDayName
{
    ...
    NSString *formatStr = @"dd/MM/yyyy HH:mm";
    NSString *baseDateStr = @"06/04/2014 00:00"; // Sunday
    int dayIndex = 0;
    NSDate *baseDate = [NSDate dateFromStringWithFormat:formatStr DateString:baseDateStr];
    
    if([self isEarlierThanDate:baseDate])
    {
        // go to past
        NSInteger diff = [self daysBeforeDate:baseDate];
        int modularDateIndex = diff%7;
        int dateIndex = modularDateIndex+dayIndex;
        return Days[Days.count - dateIndex];
    }
    else
    {
        //go to future
        NSInteger diff = [self daysAfterDate:baseDate];
        int modularDateIndex = diff%7;
        int dateIndex = modularDateIndex+dayIndex;
...
-(NSString *)GetMonthName
{
    ...
    return [monthnames objectAtIndex:[comps month]-1];
}
